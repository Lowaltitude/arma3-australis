class CfgPatches
{
	class A3_Boat_F_Destroyer_Destroyer_Australis
	{
		addonRootClass="A3_Boat_F_Destroyer_Australis";
		requiredAddons[]=
		{
			"A3_Boat_F_Destroyer"
		};
		...
		units[]=
		{
			...
			"Land_Destroyer_203_base_F",
			"Land_Destroyer_203_hull_01_F",
			"Land_Destroyer_203_hull_05_F",
			"Land_Destroyer_205_base_F",
			"Land_Destroyer_205_hull_01_F",
			"Land_Destroyer_205_hull_05_F",
			"ShipFlag_AU_F"
		};
		weapons[]={};
	};
...
class CfgVehicles
{
	...
	class Land_Destroyer_202_base_F: StaticShip
	{
		author="Lowaltitude";
		...
		icon="iconObject_1x1";
		displayName="Destroyer [HMAS Hammersley]";
		mapsize=155;
		destrType=0;
		featureType=2;
		multiStructureParts[]=
		...
		class Attributes
		{
			class CustomShipNameTexture0
			{
				...
				typeName="STRING";
				defaultValue="'destroyer_f_australis\destroyer_01\data\destroyer_01_tag_202_co'";
			};
			class CustomShipFlagTexture0
			{
				...
				typeName="STRING";
				defaultValue="'\A3\destroyer_f_australis\destroyer_01\data\flag_ane_co'";
			};
	...
	class Land_Destroyer_202_hull_01_F: Land_Destroyer_01_hull_base_F
	{
	...
	class Land_Destroyer_202_hull_05_F: Land_Destroyer_01_hull_05_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\A3\destroyer_f_australis\destroyer_01\data\destroyer_01_tag_202_co.paa"
		};
		ladders[]=
		{
	...
	class ShipFlag_AU_F: FlagCarrier
	{
		...
		class EventHandlers
		{
			init="(_this select 0) setFlagTexture '\A3\destroyer_f_australis\destroyer_01\data\flag_ane_co.paa'";
		};
	};
	class Land_Destroyer_203_base_F: StaticShip
	{
		author="Lowaltitude";
		model="\A3\Boat_F_Destroyer\Destroyer_01\Destroyer_01_hull_base_F.p3d";
		reversed=0;
		...
		vehicleClass="Structures_Military";
		icon="iconObject_1x1";
		displayName="Destroyer [HMAS Camden]";
		mapsize=155;
		destrType=0;
		featureType=2;
		multiStructureParts[]=
		...
		class Attributes
		{
			class CustomShipNameTexture0
			{
				...
				expression="([_this, 'Land_Destroyer_01_hull_05_F'] call bis_fnc_destroyer01GetShipPart) setObjectTextureGlobal [0, _value];";
				typeName="STRING";
				defaultValue="'\A3\destroyer_f_australis\destroyer_01\data\destroyer_01_tag_203_co'";
			};
			class CustomShipFlagTexture0
			{
				displayName="$STR_3den_object_attribute_CustomShipFlagTexture0_displayname";
	...
	class Land_Destroyer_203_hull_01_F: Land_Destroyer_01_hull_base_F
	{
		displayName="$STR_A3_Land_Destroyer_01_hull_01_F";
		editorPreview="\A3\EditorPreviews_F_Destroyer\Data\CfgVehicles\Destroyer_01_hull1.jpg";
		model="\A3\Boat_F_Destroyer\Destroyer_01\Destroyer_01_hull_01_F.p3d";
	...
	class Land_Destroyer_203_hull_05_F: Land_Destroyer_01_hull_05_F
	{
		editorPreview="\A3\EditorPreviews_F_Destroyer\Data\CfgVehicles\Destroyer_01_hull5.jpg";
		displayName="$STR_A3_Land_Destroyer_01_hull_05_F";
		model="\A3\Boat_F_Destroyer\Destroyer_01\Destroyer_01_hull_05_F.p3d";
		...
		hiddenSelectionsTextures[]=
		{
			"\A3\destroyer_f_australis\destroyer_01\data\destroyer_01_tag_203_co.paa"
		};
		ladders[]=
		{
	...
	class Land_Destroyer_205_base_F: StaticShip
	{
		author="Lowaltitude";
		model="\A3\Boat_F_Destroyer\Destroyer_01\Destroyer_01_hull_base_F.p3d";
		reversed=0;
		...
		vehicleClass="Structures_Military";
		icon="iconObject_1x1";
		displayName="Destroyer [HMAS Kingston]";
		mapsize=155;
		destrType=0;
		featureType=2;
		multiStructureParts[]=
		...
		class Attributes
		{
			class CustomShipNameTexture0
			{
				...
				expression="([_this, 'Land_Destroyer_01_hull_05_F'] call bis_fnc_destroyer01GetShipPart) setObjectTextureGlobal [0, _value];";
				typeName="STRING";
				defaultValue="'\A3\destroyer_f_australis\destroyer_01\data\destroyer_01_tag_205_co'";
			};
			class CustomShipFlagTexture0
			{
				displayName="$STR_3den_object_attribute_CustomShipFlagTexture0_displayname";
	...
	class Land_Destroyer_205_hull_01_F: Land_Destroyer_01_hull_base_F
	{
		displayName="$STR_A3_Land_Destroyer_01_hull_01_F";
		editorPreview="\A3\EditorPreviews_F_Destroyer\Data\CfgVehicles\Destroyer_01_hull1.jpg";
		model="\A3\Boat_F_Destroyer\Destroyer_01\Destroyer_01_hull_01_F.p3d";
	...
	class Land_Destroyer_205_hull_05_F: Land_Destroyer_01_hull_05_F
	{
		editorPreview="\A3\EditorPreviews_F_Destroyer\Data\CfgVehicles\Destroyer_01_hull5.jpg";
		displayName="$STR_A3_Land_Destroyer_01_hull_05_F";
		model="\A3\Boat_F_Destroyer\Destroyer_01\Destroyer_01_hull_05_F.p3d";
		...
		hiddenSelectionsTextures[]=
		{
			"\A3\destroyer_f_australis\destroyer_01\data\destroyer_01_tag_205_co.paa"
		};
		ladders[]=
		{
