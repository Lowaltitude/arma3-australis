class Australis_B_A_APC_Wheeled_01_cannon_v2_F: APC_Wheeled_01_base_v2_F
{
	...
	crew = Australis_B_A_Crew_F;
	typicalCargo[] = {Australis_B_A_Crew_F};
	textureList[] = {ADF,1};
...
class Australis_B_A_APC_Wheeled_01_command_lxWS: APC_Wheeled_01_command_base_lxWS
{
    author = $STR_A3_A_BranFlakes;
...
class Australis_B_A_APC_Wheeled_01_mortar_lxWS: APC_Wheeled_01_mortar_base_lxWS
{
    author = $STR_A3_A_BranFlakes;
...
class Australis_B_A_APC_Wheeled_01_atgm_v2: APC_Wheeled_01_atgm_base_v2
{
    author = $STR_A3_A_BranFlakes;
    scope = public;
    scopeCurator = public;
