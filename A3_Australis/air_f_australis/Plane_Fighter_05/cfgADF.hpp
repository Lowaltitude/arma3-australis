class Australis_B_A_Plane_Fighter_05_F: Plane_Fighter_05_Base_F
{
	...
	crew = Australis_B_A_Fighter_Pilot_F;
	typicalCargo[] = {Australis_B_A_Fighter_Pilot_F};
	textureList[] = {ADF,1};
...
class Australis_B_A_Plane_Fighter_05_Stealth_F: B_Plane_Fighter_05_Stealth_F
{
	author = $STR_A3_A_AveryTheKitty_and_OlliKoskelainen;
...
class Australis_B_A_Ejection_Seat_Plane_Fighter_05_F: Ejection_Seat_Plane_Fighter_05_base_F
{
	class SimpleObject
	{
		eden = false;
