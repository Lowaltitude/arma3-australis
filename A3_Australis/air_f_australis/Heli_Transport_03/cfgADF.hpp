class Australis_B_A_Heli_Transport_03_F: Heli_Transport_03_base_F
{
	...
	//editorPreview = "\A3_Australis\EditorPreviews_F_Australis\Data\CfgVehicles\B_T_Heli_Transport_03_F.jpg"; TBD
	scope = public;
	scopeCurator = public;
	side = TWest;
	...
	class Turrets: Turrets
	{
        ...
        {
            gunnerType = Australis_B_A_Helipilot_F;
        };
...
class Australis_A_Heli_Transport_03_unarmed_F: Heli_Transport_03_unarmed_base_F
{
	...
	//editorPreview = "\A3_Australis\EditorPreviews_F_Australis\Data\CfgVehicles\B_A_Heli_Transport_03_unarmed_F.jpg"; TBD Later
	scope = public;
	scopeCurator = public;
