class Australis_B_A_Plane_Fighter_01_F: B_Plane_Fighter_01_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\B_T_Plane_Fighter_01_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TWest;
	...
	{
		EjectionSeatClass = Australis_B_A_Ejection_Seat_Plane_Fighter_01_F;
	};
};
class Australis_B_A_Plane_Fighter_01_Stealth_F: B_Plane_Fighter_01_Stealth_F
{
	author = $STR_A3_A_Lowaltitude;
    class SimpleObject
	{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\B_T_Plane_Fighter_01_Stealth_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TWest;
	faction = Australis_BLU_AU_F;
...
class Australis_B_A_Ejection_Seat_Plane_Fighter_01_F: Ejection_Seat_Plane_Fighter_01_base_F
{
	class SimpleObject
	{
		eden = false;
